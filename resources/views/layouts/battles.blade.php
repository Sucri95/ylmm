...
@media(max-width: 1700px) {
  .my-text-center.video-container .my-center.profile.slider-row, 
  .my-text-center.video-container1 .my-center.profile.slider-row{
    margin: 1em 0em 3em 15em!important;
  }
  .slider-row3.profile.my-center div.video,
...
@media(max-width: 1500px) {
  .my-text-center.video-container .my-center.profile.slider-row, 
  .my-text-center.video-container1 .my-center.profile.slider-row{
    margin: 1em 0px 3em 70px!important;
  }
}
...
<div class="messages">
  <div class="container">
    <div class="close-messages"></div>
      <p style="text-align: center;">¡No ha seleccionado todos los favoritos!</p>
      <div class="message-image">
        <img src="../../images/resources/logo_sm.png">
    </div>
  </div>
...
<div class="share-overlay">
 ...
 <!-- Nav area -->
  ...
  <div class="container" >
    <div class="slider-type-2" style="padding: 0px;">
        ...
        <div class="container-title">
            <h1>ELEGÍ A TUS FAVORITAS</h1>
            <h3>LAS MÁS VOTADAS PASAN A LA PRÓXIMA RONDA</h3>
          </div>
        </div>
    </div>
  </div>
  ...
  <div class="top-profile-menu" >
    ...
    <div class="stats cf in-left" style="float: left; margin-left: 4%;">

      <a class="stat orderby" href="/battles/key">ORDERNAR POR:</a>
      <a class="stat" href="/battles/views">Más vistos</a>
      <a class="stat" href="/battles/lastadded">Últimos subidos</a>
      <a class="stat" href="/battles/mostvoted">Más votados</a>
      <a class="stat" href="/battles/letters">Alfabéticamente</a>

    </div>
    <div class="stats cf follow-container orderby" style="display: none;">

        <a class="stat" href="/battles/key">ORDERNAR POR:</a>
    ...
    <div class="mobile-submenu">
     ...
     <ul class="submenu-menu-mobile">
          <li><a class="stat" href="/battles/views">Más vistos</a></li>
          <li><a class="stat" href="/battles/lastadded">Últimos subidos</a></li>
          <li><a class="stat" href="/battles/mostvoted">Más votados</a></li>
          <li><a class="stat" href="/battles/letters">Alfabéticamente</a></li>
      </ul>  
