...
<a href="http://localhost:8000/emailvalidation?id={{$user->id}}&token=<?php echo $topica['especificaciones']; ?>">http://localhost:8000/users/home_fan?token=<?php echo $topica['especificaciones']; ?></a>
