...
@section('content')
  ...
  <h1  class="battles-title"><b>Batalla de Bandas:</b> Llave 4</h1>
    <div class="container">
      <div class="inner-container">
        <div class="video-area">
          @foreach($videos as $video)
          <?php $band = DB::table('bands')->where('id', $video->id_band)->first(); ?>
        ...
        <h1 class="favorite-select-battle" ><b>TUS 5 FAVORITAS</b></h1>
          ...
          <form class="form-register" action="{{ action('BattleController@fourthkey_votes') }}" method="post" role="form">
