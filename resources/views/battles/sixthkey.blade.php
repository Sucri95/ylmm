...
@section('content')
  ...
  <h1  class="battles-title"><b>Batalla de Bandas:</b> Llave 6</h1>
    <div class="container">
      <div class="inner-container">
        ...
        <h1 class="favorite-select-battle" ><b>ELEGÍ AL GANADOR</b></h1>
          <div class="my-right votes">
          <form class="form-register" action="{{ action('BattleController@sixthkey_votes') }}" method="post" role="form">
