...
<a href="http://localhost:8000/membersvalidation?id={{$user->id}}&idband={{$band}}&role={{$role}}&token={{$topica['especificaciones']}}">http://localhost:8000/membersvalidation?token=<?php echo $topica['especificaciones']; ?></a>
