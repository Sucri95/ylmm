      ...
      <div class="main-post">
        ...
        <div class="post-area">
          ...
          <div class="input-area">
              <!-- <textarea></textarea> -->
             <!--  new textarea -->  
              <div id="content" contenteditable="true" class="input-text main-textarea" style="outline:0px;"></div>
              <div class="contactList">
                <ul class="full-width to-left"></ul>
              </div>
              <!--  new textarea -->  
          </div>
                        ...
                        <?php if (count($response) > 0){ ?>
                              @foreach($response as $res)
                                  <?php $resuser = DB::table('users')->where('id', $res->id_user)->first(); ?>
                                  	<li class="response_id_{{$res->id}}">
                                		...
                                		<?php if (Auth::user()->id == $res->id_user) { ?>
                              ...
                              <li class="comment-post-area">
                                <div class="avatar" style="background: url('{{Auth::user()->profile_pic}}'); background-size: cover;"></div>
                                  ...
                                  <input type="hidden" class="id_band" name="id_band" value="{{ $comment['id_band'] }}">
...
var users = <?php echo $users; ?> ;
  ...
  $('.show-more').on('click',function(){
    ...
    window.location.href = "http://localhost:8000/wall/yourfavorites?id="+id;
...
$( document ).ready(function() {  
  ...
  $(document).on('click', 'nav .logo a', function() {
      $('html, body').animate({scrollTop: $('html, body').offset().top - 400}, 2200);
  });
